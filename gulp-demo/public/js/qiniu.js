   ...
   QN.imgs[id] = Qiniu.uploader({
      ...
      init: {
         ...
         'FileUploaded': function(up, file, info) {
            ...
            console.log(sourceLink);//鍥剧墖鐨勫畬鏁村湴鍧€
            console.log(domain);//鍥剧墖鐨刣omain锛堜竷鐗涙湇鍔″櫒鐨勫湴鍧€锛�
            console.log(res.key);//鍥剧墖鍚嶇О
            mm(sourceLink)
            // }
         },
         'Error': function(up, err, errTip) {
            console.log(id+'涓婁紶鍑洪敊');
            // mm(id+'涓婁紶鍑洪敊');
            if(QN.uploadError)
...
// key涓烘瘡涓枃浠朵笂浼犳垚鍔熷悗锛屾湇鍔＄杩斿洖鐨刯son瀛楁锛屽嵆璧勬簮鐨勬渶缁堝悕瀛楋紝涓嬪悓
// key鍙湪姣忎釜鏂囦欢FileUploaded浜嬩欢琚Е鍙戞椂鑾峰緱
//     QN.imgLink = Qiniu.watermark({
//         mode: 1,  // 鍥剧墖姘村嵃
//         image: 'http://77flds.com2.z0.glb.qiniucdn.com/images/logo-2.png', // 鍥剧墖姘村嵃鐨刄rl锛宮ode = 1鏃讹紝蹇呴渶
//         dissolve: 50,          // 閫忔槑搴︼紝鍙栧€艰寖鍥�1-100锛岄潪蹇呴渶锛屼笅鍚�
//         gravity: 'SouthWest',  // 姘村嵃浣嶇疆锛屼负浠ヤ笅鍙傛暟[NorthWest銆丯orth銆丯orthEast銆乄est銆丆enter銆丒ast銆丼outhWest銆丼outh銆丼outhEast]涔嬩竴
//         dx: 100,  // 妯酱杈硅窛锛屽崟浣嶏細鍍忕礌(px)
//         dy: 100   // 绾佃酱杈硅窛锛屽崟浣嶏細鍍忕礌(px)
//     }, key);      // key涓洪潪蹇呴渶鍙傛暟锛屼笅鍚�
// imgLink鍙互璧嬪€肩粰html img鍏冪礌鐨剆rc灞炴€э紝涓嬪悓
// 鑻ユ湭鎸囧畾key锛屽彲浠ラ€氳繃浠ヤ笅鏂瑰紡鑾峰緱瀹屾暣鐨刬mgLink锛屼笅鍚�
// imgLink  =  '<domain>/<key>?' +  imgLink
// <domain> 涓轰竷鐗涚┖闂达紙bucket)瀵瑰簲鐨勫煙鍚嶏紝閫夋嫨鏌愪釜绌洪棿鍚庯紝鍙€氳繃 绌洪棿璁剧疆->鍩烘湰璁剧疆->鍩熷悕璁剧疆 鏌ョ湅鑾峰彇

// 瑁佸壀
// QN.crop=function (w,h,x,y){
//     return Qiniu.imageMogr2({
//         "auto-orient": true,  // 甯冨皵鍊硷紝鏄惁鏍规嵁鍘熷浘EXIF淇℃伅鑷姩鏃嬫锛屼究浜庡悗缁鐞嗭紝寤鸿鏀惧湪棣栦綅銆�
//         crop: '!300x400a10a10',  // 瑁佸壀鎿嶄綔鍙傛暟
//         gravity: 'NorthWest',    // 瑁佸壀閿氱偣鍙傛暟
//         quality: 100,  // 鍥剧墖璐ㄩ噺锛屽彇鍊艰寖鍥�1-100
//         format: 'jpg',// 鏂板浘鐨勮緭鍑烘牸寮忥紝鍙栧€艰寖鍥达細jpg锛実if锛宲ng锛寃ebp绛�
//     },key)
// };
// 姘村嵃
