...
// æ¨¡ç‰ˆ
   function($,ufind){
      ...
      Temp.prototype.todom=function (data){
         return htmlToDom(this.tohtml(data))
      }

      Temp.prototype.reload=function (data){
         this.el.innerHTML=this.tohtml(data)
         this.el.setAttribute('temptype','show')
      }

      Temp.prototype.load=function (data){
         $(this.el)
            .attr('temptype','show')
            .append(this.todom(data))
      }

      Temp.prototype.loadUp=function (data){
         $(this.el)
            .attr('temptype','show')
            .prepend(this.todom(data))
      }
...
// æ•°æ®ç»‘å®š
   function (define,temp,$){
      ...
      // è¡¨ç¤ºæ­£åœ¨èŽ·å–ç„¦ç‚¹çš„è¾“å…¥æ¡†
      var focus_input

      // ç»‘å®šè¾“å…¥äº‹ä»¶ï¼Œå®žçŽ°åŒå‘ç»‘å®š
      ...
      function bind(data,dom){
         ...
         // ç»‘å®šï¼ˆ:src='å±žæ€§å'ï¼‰,å’Œï¼ˆ$click='alert1,alert2'ï¼‰
         var tag=$('*',dom)
            ...
            if(tag[i].attributes.length){
               ...
               for(var i2=0;i2<attr.length;i2++){
                  ...
                  if(value.indexOf('def:')==0){
                     bind_attr(n_attr,value.slice(4),data,true)
                  }
                  else
      ...
      var bindValueTags=['INPUT','TEXTAREA','SELECT']
      ...
      function bind_attr(attr,value,data,def){
               ...
               for(var i2=0;i2<eventName.length;i2++){
                  ...
                  if(typeof fn.fn=='function'){
                     ...
                     try{
                        ...
                        console.log('æ‰§è¡Œeve.'+eventName[i2]+'æ—¶å‡ºçŽ°äº†é”™è¯¯\näº‹ä»¶ç±»åž‹æ˜¯'+type+'\n',tag)
                        console.error(error)
                     }
...
// æ»‘åŠ¨æ‰‹åŠ¿å’Œclickè¡¥ä¸
   function(document){

      var ios=navigator.userAgent.toLowerCase().indexOf('iphone')!=-1;
      ...
      document.addEventListener('touchend',function(e){
         ...
         // å¦‚æžœæ˜¯å®‰å“ç³»ç»Ÿï¼Œä½†æ˜¯è§¦å‘äº†æ»‘åŠ¨æ“ä½œï¼Œå°†ä¸å†è§¦å‘click
         if(isMove && (!ios)){
            e.preventDefault()
         }

         // é’ˆå¯¹iosç³»ç»Ÿçš„clickè¡¥ä¸
